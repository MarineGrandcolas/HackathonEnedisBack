...
router.post('/', async (req, res) => {
  ...
  await insertUser(value.pseudo, hashedPassword, value.level, value.experience, 'ROLE_USER', value.email, value.avatar);
...
router.post('/', (req, res) => {
  ...
  connection.query(
    'INSERT INTO users (pseudo, password, level, experience) VALUES (?, ?, ?, ?)',
    [pseudo, password, level, experience],
    (err, result) => {
      if (err) {
        console.error(err);
